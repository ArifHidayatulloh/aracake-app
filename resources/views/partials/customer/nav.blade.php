...
<nav x-data="{ mobileMenuOpen: false, userMenuOpen: false }"
    class="sticky top-0 z-50 bg-white/90 backdrop-blur-lg shadow-lg border-b border-purple-100/20">
    <div class="container mx-auto px-6 py-4">
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center space-x-3">
                ...
                <button @click="mobileMenuOpen = !mobileMenuOpen"
                    class="md:hidden p-2 rounded-lg text-gray-700 hover:text-purple-600 hover:bg-purple-50">
        ...
        <!-- Mobile Menu (Links moved below nav) -->
        <div x-show="mobileMenuOpen" class="mobile-menu md:hidden bg-white mt-4 rounded-lg shadow-lg py-2"
            :class="{ 'open': mobileMenuOpen }">
            <a href="{{ route('home') }}"
                class="block px-6 py-3 text-gray-700 hover:text-purple-600 hover:bg-purple-50 transition-all duration-300">
                Beranda
            </a>
            <a href="{{ route('product') }}"
                class="block px-6 py-3 text-gray-700 hover:text-purple-600 hover:bg-purple-50 transition-all duration-300">
